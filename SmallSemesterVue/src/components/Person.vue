...
export default {
    ...
    data () {
        return {
            ...
            uniqueOpened:false,
            tableData: [],
            tableData1: [{info:"姓名"},{info:"性别"},{info:"电子邮箱"}],
            tableData2: [],
    ...
    created: function(){
        axios({
            method: 'post',
            url: 'http://localhost:8000/api/showpersonalintro/',
        ...
        .then(response => {
            ...
            if(response.data.code === 400){
                ...
                this.tableData2 = [{'info': response.data.name}, {'info': response.data.sex}, {'info': response.data.email}]
