<template>
    <div>
       ...
       <el-container>
            ...
            <el-menu default-active="2-3" class="el-menu-vertical-demo" :default-openeds="opend"
...
export default {
    ...
    methods: {
        ...
        RmFavorDoc(row){
            axios({
                method: 'post',
                url: 'http://localhost:8000/api/removefavoritedoc/',
    ...
    created: function(){
        axios({
            method: 'post',
            url: 'http://localhost:8000/api/showfavoritedoclist/',
